...
const ComponentInvocation = class {
    ...
    text() {
        ...
        console.fine('SDK: Retrieving request text=' + text);
        return text;
    }
    ...
    variable(name, value) {
        ...
        if (value === undefined) {
            ...
            console.fine('SDK: About to set variable ' + name);
            ...
            {
                console.fine('SDK: Creating new variable ' + nameToUse);
            ...
            console.fine('SDK: Setting variable ' + JSON.stringify(context.variables[nameToUse]));
            return this;
        }
    }
        ...
        if (nlpVariableName === undefined) {
            for (let name in this._response.context.variables) {
                if (this._response.context.variables[name].type === NLPRESULT_TYPE) {
                    console.fine('SDK: using implicitly found nlpresult=' + name);
